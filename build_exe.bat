...
taskkill /F /IM StyleCutDesk.exe >nul 2>&1
timeout /t 2 /nobreak >nul

if exist "dist\StyleCutDesk.exe" (
  del /f /q "dist\StyleCutDesk.exe" >nul 2>&1
)
if exist "dist\StyleCutDesk.exe" (
  echo [ERROR] Cannot replace dist\StyleCutDesk.exe
...
echo.
echo OK
echo EXE: "%cd%\dist\StyleCutDesk.exe"
echo.
if exist "dist\StyleCutDesk.exe" explorer dist
pause
